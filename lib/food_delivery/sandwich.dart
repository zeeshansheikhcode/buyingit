/**
 * This File contains all Sandwich Products
 */
...
class _SandwichScreenState extends State<SandwichScreen> {
  ...
  Widget build(BuildContext context) {
   ...
   List<Product> _allitems = products.items + products.trendingItems;
    ...
    {
        if(_allitems[i].category == 'Sandwich' || _allitems[i].category == 'Trending Sandwich' )
        {
    ...
    return  Scaffold(
               ...
               {   
                   ...
                   onTap: (){
                   if(_selecteditems[index].category == 'Trending Sandwich')
                        {
